...
#define FLAG_TIMEOUT_COLUMNA_DISPLAY 	0x02

enum led_display_columns_values {
	LED_DISPLAY_COLUMNA_0,
	LED_DISPLAY_COLUMNA_1,
	LED_DISPLAY_COLUMNA_2,
	LED_DISPLAY_COLUMNA_3,
	LED_DISPLAY_COLUMNA_4,
	LED_DISPLAY_COLUMNA_5,
	LED_DISPLAY_COLUMNA_6,
	LED_DISPLAY_COLUMNA_7,
};
