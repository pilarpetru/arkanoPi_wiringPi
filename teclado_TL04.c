...
void InicializaTeclado(TipoTeclado *p_teclado) {
	...
	printf("\nCONTROLES:\n");
	printf("0: Iniciar/Reiniciar el juego\n");
	printf("*: Mover pala a la izquierda\n");
	printf("#: Mover pala a la derecha\n");
...
void ActualizaExcitacionTecladoGPIO (int columna) {
	...
	switch(columna){
		case COLUMNA_1:
			digitalWrite(GPIO_KEYBOARD_COL_4,LOW); // desactivamos primero el anterior caso
			digitalWrite(GPIO_KEYBOARD_COL_1,HIGH);
			digitalWrite(GPIO_KEYBOARD_COL_2,LOW);
			digitalWrite(GPIO_KEYBOARD_COL_3,LOW);
			break;
		...
		case COLUMNA_2:
			digitalWrite(GPIO_KEYBOARD_COL_1,LOW); // desactivamos primero el anterior caso
		...
		case COLUMNA_3:
			digitalWrite(GPIO_KEYBOARD_COL_2,LOW); // desactivamos primero el anterior caso
		...
		case COLUMNA_4:
			digitalWrite(GPIO_KEYBOARD_COL_3,LOW); // desactivamos primero el anterior caso
